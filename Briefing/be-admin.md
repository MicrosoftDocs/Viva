...
* **Exchange Online (EXO) admin, Global admin, or Insights admin role** - You must have an Exchange Online (EXO) admin role, a Global admin role, or an Insights admin role to configure users for Briefings in PowerShell.
