...
![Employee engagement page](../workplaceanalytics/images/wpa/use/boost-ee.png)

## Calculations

The following are the percentage insights, their underlying metrics, and a little about the calculations used for them.

![Employee engagement percentage insight](../workplaceanalytics/images/wpa/use/boost-ee-percent.png)
...
![Employee engagement visual insight](../workplaceanalytics/images/wpa/use/boost-ee-visual.png)
...
* Use [MyAnalytics wellbeing data](../workplaceanalytics/MyAnalytics/Use/wellbeing.md) to learn about after-hours work habits and encourage your team to take time to disconnect and recharge.
* Use [Inline suggestions in Outlook](../workplaceanalytics/MyAnalytics/Use/mya-notifications.md#delay-email-delivery) to automatically delay email delivery to align with configured working hours for coworkers.
