...
title: Enhance operational effectiveness with Workplace Analytics insights
...
For more best practices and ways to schedule shorter meetings, see [Best practices for meetings](https://docs.microsoft.com/workplace-analytics/tutorials/gm-meetings.md).
...
* Use [MyAnalytics](https://docs.microsoft.com/workplace-analytics/myanalytics/use/mya-notifications.md#shorten-a-meeting) to shorten meetings. For example, when you're composing a meeting invitation with a duration of one hour, an inline suggestion will remind you to shorten the meeting by 15 minutes.
...
* Use the [MyAnalytics Insights to prepare for meetings](https://docs.microsoft.com/workplace-analytics/myanalytics/use/use-the-insights.md#prepare-for-your-meetings). It provides insights about meeting information, related documents, and reminders to book preparation time.
...
For more best practices and ways to maintain the interest and participation of meeting attendees, see [Best practices for meetings](https://docs.microsoft.com/workplace-analytics/tutorials/gm-meetings.md).
...
* Use the [MyAnalytics Focus plan](https://docs.microsoft.com/workplace-analytics/myanalytics/use/focus-plan.md) to automatically book focus time and protect this time by silencing chats, and allows you to track your progress weekly.
...
For more best practices and ways to protect the time of yourself and others, see [Best practices for focus time](https://docs.microsoft.com/workplace-analytics/tutorials/gm-focus.md).
