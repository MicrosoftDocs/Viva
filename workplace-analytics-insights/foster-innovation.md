...
* Use a [MyAnalytics Focus plan](/viva/insights/personal/use/focus-plan) to automatically book focus time, protect this time by silencing chats, and track weekly progress.
...
* Use [Insights](/viva/insights/personal/use/use-the-insights) and the [Network](https://docs.microsoft.com/workplace-analytics/myanalytics/use/network) page to see connections, top collaborators, and suggestions on how to improve connections and cultivate influence.
