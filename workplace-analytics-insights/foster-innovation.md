...
title: Foster innovation in Workplace Analytics insights
...
![Foster innovation page](../workplaceanalytics/images/wpa/use/innovation.png)

## Calculations

The following are the percentage insights, their underlying metrics, and a little about the calculations used for them.

![Foster innovation percentage insight](../workplaceanalytics/images/wpa/use/innovation-percent.png)

|Behavior |Percentage insight | Metrics |Calculations |
|---------|--------|--------------------|----------------------|
|Enable deep work |Percentage of employees have less than 20 hours for deep work each week |[Total focus hours](../workplaceanalytics/use/metric-definitions.md#focus-define) |The percentage of employees who have less than 20 hours available to focus each week. Calculated weekly and averaged over the time period. |
|Utilize influencers |Percentage of organizations who have few influencers |[Influence](../workplaceanalytics/use/metric-definitions.md#organizational-network-analysis-ona-metrics) |Influencers are employees with the best connections to people across the company based on their collaboration patterns. This insight highlights the organizations that don't have sufficient representation of them, based on company and organization size. |

The following defines the organizational data shown in the visual behavioral insights.

![Foster innovation visual insight](../workplaceanalytics/images/wpa/use/innovation-visual.png)

|Behavior |Visual insight | Calculations|
|---------|--------|----------|------------|
|Enable deep work |Distribution of time for deep work |Percentage of employees grouped by their [focus time](../workplaceanalytics/use/metric-definitions.md#focus-define). The groups are divided into those who spend between 0 and 10 hours, 10 and 20 hours, 20 and 40 hours, and more than 40 hours focusing. The percentages are calculated weekly and averaged over the entire time period. |
|Utilize influencers |Organizations with limited influencers |Percentage organizations that don't have sufficient representation of influencers, based on company size. This uses the [influence](../workplaceanalytics/use/metric-definitions.md#organizational-network-analysis-ona-metrics) metric.|
...
* **Opportunity groups** - Lists the groups who are most affected and would benefit the most from these recommended best practices or [Plans](../workplaceanalytics/Tutorials/solutionsv2-intro.md), which are based on your organizational data and industry research.
* **Explore the stats** – Depending on the recommendation, this links to data about [Internal networks](../workplaceanalytics/use/explore-metrics-internal-networks.md) or [Teamwork](../workplaceanalytics/tutorials/teamwork-solution.md).
* **Explore in Power BI** - If available, links to [Power BI reports](../workplaceanalytics/tutorials/power-bi-intro.md) for more advanced analysis for one or more of the recommendations.
* **Plans** - Opens a new [Plan](../workplaceanalytics/Tutorials/solutionsv2-intro.md) you can set up relating to one or more of the recommendations.
...
* Use a [MyAnalytics Focus plan](../workplaceanalytics/myanalytics/use/focus-plan.md) to automatically book focus time, protect this time by silencing chats, and track weekly progress.

For more best practices and ways to establish a 'no meeting' period, see [Best practices for focus time](../workplaceanalytics/tutorials/gm-focus.md).
...
* Use [Insights](../workplaceanalytics/myanalytics/use/use-the-insights.md) and the [Network](../myanalytics/use/network.md) page to see connections, top collaborators, and suggestions on how to improve connections and cultivate influence.
