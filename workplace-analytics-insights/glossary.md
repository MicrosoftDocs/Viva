...
| <a name="measured-employees"></a> Measured employees | The employees to whom your Insights administrator assigned licenses during setup. After license assignment, Insights extracts Office 365 data about meetings, email, unscheduled calls, and instant messages for these people. If you are an analyst or limited analyst, this is the population that you can analyze within Insights. The number of measured employees can help determine whether you have good data coverage for analysis.|
