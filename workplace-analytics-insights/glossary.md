...
|<a name="ona-define"></a> Organizational network analysis (ONA) |Studies communication and uses social network theory and dynamic network analysis to create statistical and graphical models of people, tasks, groups, knowledge, and resources within an organization.|
