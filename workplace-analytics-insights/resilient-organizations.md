...
For more best practices and ways to establish better manager-team connections, see [Best practices for manager coaching](../workplaceanalytics/tutorials/gm-coaching.md).
