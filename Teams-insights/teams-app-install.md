...
_**Note:** Starting mid-March, 2021, the Microsoft Viva Insights app will be discoverable the Teams app bar (on the left) by selecting the ellipsis (…). You can also locate the Insights app through this link: https://aka.ms/InsightsTeamsApp._
