...
Microsoft Viva Insights has a **My organization** page that shows leader's collaboration data about their team. The outcomes include data about **Boost  engagement**, which you can select in **My organization** to see more details.
...
For example, in **Outcomes**, select **Boost engagement** to see more about it:
...
To take action on an outcome, you can select **View best practices** to see a list of recommendations for an insight, such as increasing the frequency of coaching:
...
* Use [MyAnalytics wellbeing data](../personal/Use/wellbeing.md) to learn about after-hours work habits and encourage your team to take time to disconnect and recharge.
...
* Ask employees to use [MyAnalytics network features](../personal/use/network.md) to add people to their "important people" list, which enables suggestions to meet and reminders to respond to emails and complete tasks from them.
