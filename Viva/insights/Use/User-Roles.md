...
* One person can be both an Microsoft 365 admin and a Viva Insights admin.
* One person can be both a Viva Insights admin and an analyst. However, it is a best practice to assign the admin and analyst roles to different people to prevent any misuse of or external linking of organizational data with collaboration metrics.
