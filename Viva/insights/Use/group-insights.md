...
* **Licensed team** - The members of your team are assigned [Viva Insights licenses](../setup/environment-requirements.md#viva-insights-licenses) with the [MyAnalytics (Full) service plan](../personal/overview/plans-and-environments.md) and are included in the reporting hierarchy that leads to you as their manager.
