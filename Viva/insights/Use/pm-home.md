...
To grant managers access to [My team in Viva Insights](../org-team-insights/teamwork-habits.md) and to Manager insights in the advanced insights app, your Viva Insights admin must add them as managers in [Manager settings](/viva/insights/use/manager-settings?toc=/viva/insights/use/toc.json&bc=/viva/insights/breadcrumb/toc.json).
