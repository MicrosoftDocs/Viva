...
* [Organizational data](organizational-data.md) - Shows information about your company that you provide to Viva Insights through uploads of organizational (HR) data. However, if you purchased a license for Viva Insights starting October 2021, Viva Insights initially uses Azure AD data to present data about your organization. However, your admin can set up Viva Insights to use the advanced insights app with uploaded HR data instead.
