...
A8. No, Advanced insights in Viva Insights does not currently support mailboxes in [Sweden go-local](/microsoft-365/enterprise/o365-data-locations). To get updated data for advanced insights, you can't have [licenses assigned](../setup/Assign-licenses-to-population.md) to users with mailboxes in Sweden go-local.
