...
* Use [Insights](../personal/use/use-the-insights.md) and the [Stay connected](../personal/teams/teamwork.md) page to see connections, top collaborators, and suggestions on how to improve connections and cultivate influence.
