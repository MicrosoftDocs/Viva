...
In the **Group details** section of the **Upload group** panel, you can set a value for Max target. This is not your final opportunity to set this target. After you submit your group, Viva Insights calculates for the group a benchmark value that pertains to the plan type. After you see the benchmark value, you can re-adjust the target.
-->

<!-- 
### Threshold

Over the course of a plan, participants receive messages from Viva Insights about their progress. Participants who have success in meeting the target you set receive a message such as 'Keep up the good work!' Those who have not yet met the target receive a message that encourages them to work towards that target.
