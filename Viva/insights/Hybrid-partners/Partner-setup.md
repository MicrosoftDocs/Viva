...
description: How to set up an on-premises Exchange server to work with Microsoft Viva Insights
author: madehmer
ms.author: v-mideh
ms.topic: article
...
|Test the solution|Review pilot results|<ul><li>Copy pilot data from on-premises to Microsoft 365​​</li><li>Coordinate testing with Microsoft​​</li><li>Resolve any issues with the solution</li></ul>|Confirm the pilot data is available to Viva Insights and sign-off on the solution
|Production|<ul><li>Confirm data is available to Viva Insights</li><li>Provide scope changes, if any</li></ul>|<ul><li>Copy all scoped mailboxes​</li><li>Provide status reports to the customer and to Microsoft​</li><li>Copy any deltas, continuously or daily​</li><li>Clean up mailboxes when ready to migrate</li></ul>|Monitor production data to check it’s available to Viva Insights
...
![Viva Insights storage mailboxes.](./images/storage-mailboxes.png)
...
* For personal guidance with partner solutions or help with Viva Insights setup and data analysis, email the Viva Insights FastTrack team at <wpaft@Microsoft.com>.
