...
title: Introduction to attendee and meeting exclusions in Viva Insights 
description: Introduction to exclusion rules in Microsoft Viva Insights 
author: madehmer
ms.author: v-pausch
ms.topic: article
...
**Owners** – Viva Insights Analysts have full access and limited Analysts have read-only access to these settings. For details, see [Assign roles to Viva Insights admins and analysts](../setup/assign-roles-to-wpa-admins.md).

![Analysis settings in Viva Insights.](../images/WpA/Tutorials/analysis-settings.png)
