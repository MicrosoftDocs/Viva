...
||<a name="time-in-self-organized-meetings-define">Time in self-organized meetings | Number of open one-hour blocks in a person’s calendar without any scheduled meetings during the workday|Count
