...
1. Go to the [setup tab] (https://admin.microsoft.com/adminportal/home#/viva) and select **Microsoft Viva**, then **Viva Insights**. You'll need to enter your credentials if you're not already signed in.
