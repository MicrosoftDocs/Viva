...
Only managers whose team meets or exceeds the **Minimum team size** setting can access **Organization trends** in the Viva Insights app. The other admin tasks required for **Organization trends** access are the same as for access to **Teamwork habits** <!--verify-->. See [Admin tasks](/viva/insights/personal/teams/viva-teams-app-admin-tasks.md) for details.
