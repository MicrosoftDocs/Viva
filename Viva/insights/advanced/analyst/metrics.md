...
![clone](../images/analyst-customize-metric-1.png)
...
![add metrics](../images/analyst-customize-metric-clone.png)
...
![collaboration type](../images/analyst-customize-metric-collab-type.png)
...
![filter](../images/analyst-customize-metric-filter.png)

We customize a sample metric below, where we give an example of how you might use filters.
...
![time window](../images/analyst-customize-metric-time-window.png)
...
![name and publish](../images/analyst-customize-metric-name-publish.png)
...
![confirm publish](../images/analyst-customize-metric-publish-confirm.png)
...
1. Find a metric to customize:
    ...
    ![clone metric](../images/analyst-customize-metric-sample-category1.png)
...
1. You decide that **Meetings hours on Friday** is the metric you want to customize. Select the ellipses (**...**) to the right of the metric name, and then select **Clone**.
    ...
    ![clone metric](../images/analyst-customize-metric-sample-clone.png)
...
1. Make changes to the metric settings:
    ...
    1. The metric has a filter set up to measure Fridays. However, you wanted to know about Friday afternoons specifically. In the **Filter and define collaboration type(s)** section, replace the existing condition with a condition group, which will measure two simultaneous conditions (Friday *and* afternoon).
        ...
        ![trashcan](../images/analyst-customize-metric-sample-trashcan.png)
        
        1. Select **Add condition group**.
        ![trashcan](../images/analyst-customize-metric-sample-add-cg.png)
        1. When your condition group appears, select **Add new condition** to add the "Friday" part of your condition group.
        ![add condition 1](../images/analyst-customize-metric-sample-add-c1.png)
            1. Set **Day of the Week** as the **Attribute**, **=** as the **Operator**, and **Friday** as the **Value**.
        ![condition 1](../images/analyst-customize-metric-sample-c1.png)
        1. Select **Add condition** again to add the "afternoon" part of your condition group.
            ...
            ![condition 1](../images/analyst-customize-metric-sample-c2.png)
        These are all the filters you'll need to set for this metric, so you  move on to the next section. 
...
![time window for sample](../images/analyst-customize-metric-sample-time-window.png)
1. In **Name and publish**, choose a new name for your metric and add to its description.
![name and publish for sample](../images/analyst-customize-metric-sample-name-publish.png)
1. Select **Save**. 
1. You think other analysts in your organization might use this metric at some point, so you also select **Publish** when Viva Insights asks.
