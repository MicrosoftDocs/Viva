...
| | IMs sent to small group without manager | Number of IMs the person sent to an internal group of eight or less people, including the sender, where the person's manager is not in the recipient group. | Count |
