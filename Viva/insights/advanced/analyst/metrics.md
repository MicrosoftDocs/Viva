...
| | IMs sent to small group without manager | Number of IMs the person sent to an internal group of eight or less people, including the person as the sender and excluding the person's manager from the recipient group. | Count |
