...
![Hybrid workforce experience Power BI report, Report summary](/viva/insights/advanced/images/hwfe-ga-pbi-summary.png)
...
* **Exclusions** – Use the check boxes to:
    ...
    * Exclude weeks that are likely holiday or paid-time-off weeks, or weeks that individuals are on other types of leave.
    ...
    ![Hybrid workforce experience Power BI report, Customize work mode](/viva/insights/advanced/images/hwfe-ga-pbi-settings.png)
