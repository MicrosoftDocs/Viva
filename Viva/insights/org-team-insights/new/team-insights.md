...
You'll find insights about quiet time impact on the **Wellbeing** tab. Learn how we calculate quiet hours impact in [Quiet time](../../personal/new/teams/quiet-time.md).

### Shared plans

To create healthy team norms, you and your team might consider using shared plans. You can find and start [shared no-meeting day](../../personal/teams/new/shared-no-meeting-day.md) and [focus](../../personal/teams/shared-focus-plan.md) plans on the **Wellbeing** tab. To start a [shared meeting plan](../../personal/teams/new/shared-meeting-plan.md), visit the **Productivity** tab. To set up regularly scheduled 1:1 meetings with your direct reports, check out [1:1 plans](../../personal/teams/new/1-1-plan.md) on the **Teamwork** tab.
