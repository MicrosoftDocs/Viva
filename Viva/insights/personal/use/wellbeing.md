...
* **Be a thoughtful coworker!** Establishing quiet time with no meetings or email can lead to better teamwork:
  ...
  * Use [schedule send suggestions](../use/mya-notifications.md#schedule-send-suggestions) to schedule email delivery when the recipients are within their working hours. Limit late-night and early-morning email to urgent email only, to cut through the noise.
