...
:::image type="complex" source="./images/productivity-mep-start1.png" alt-text="Screenshot that shows the Shared meeting plan card on the Effective meetings tab.":::
...
:::image type="complex" source="./images/productivity-mep-step-2.png" alt-text="Screenshot that shows typing to add participants (step 2/2).":::
   Screenshot of the second step of the "Create a shared meeting plan" process. The window's title is, "Share the plan with your team" and the subtitle reads, "Invite your team to participate in the plan with you. Start typing a name to search for people you want to add." Beneath the subtitle is a window showing tags for various invited participants, which inludes their profile image and name. There's a search function to the right. A dropdown menu shows suggested participants. There's a "Back" link on the bottom left of the window. On the bottom right of the window, there are two buttons: "Cancel" and "Next."
:::image-end:::
...
:::image type="complex" source="./images/productivity-mep-invitee-1.png" alt-text="Screenshot that show's a recipient's Teams invitation to join a shared meeting plan.":::
   Screenshot of the notification a plan invitee gets. The top shows the organizer's profile image and a title that reads, "Babak Shammas invited you to join a shared meeting plan." A subtitle reads, "Join Babak Shammas and their team in adoption healthy meeting norms. This meeting plan helps you automatically follow research backed meeting best practices." Beneath the subtitle is a "Learn more" link. The section below is titled, "Plan details" and includes details about the three selections the organizer made when they set up the plan. The first reads, "Automatically shorten meetings by ending events early by 5 mins for events less than an hour and by 10 mins for events that are one hour or longer." The seond reads, "Automatically add a Teams meeting link to all your meetings." The third reads, "Automatically send a survey to your meeting particpants to get feedback on your meetings." On the bottom right of the notification window, there are two buttons: "Edit" and "Join."
:::image-end:::
...
:::image type="complex" source="<folderPath>" alt-text="Screenshot that shows the Shared meeting plan card on the Productivity tab.":::
...
:::image type="complex" source="<folderPath>" alt-text="Screenshot that shows the Effective meetings settings in the Teams settings page for Viva Insights.":::
...
:::image type="content" source="./images/smp-leave2.png" alt-text="Screenshot that shows the Shared meeting plan setting and the Leave plan button highlighted in the Effective meetings section of the Viva Insights settings page.":::
...
:::image type="complex" source="./images/productivity-mep-end-plan.png" alt-text="Screenshot that shows the confirmation window to end the shared meeting plan.":::
...
![Screenshot that shows the confirmation window to end the shared meeting plan. The window contains the Confirm button.](./Images/productivity-mep-end-plan.png)
