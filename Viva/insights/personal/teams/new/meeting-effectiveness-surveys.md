...
*Applies to: users with a Viva Insights subscription. Refer to [Plans and environments](../../Overvi../../plans-environments.md) for more information.*
...
:::image type="complex" source="imag../../effective-meetings-share-feedback.png" alt-text="Screenshot that shows the feedback survey.":::
...
As an organizer with a [Viva Insights subscription](http../..//www.microsoft.c../../microsoft-vi../../insights), you can see aggregated survey results in the Viva Insights app in Teams and on the web. These results include an aggregated view of star ratings and access to individual, anonymous feedback. The **Effective meetings** section also shows insights into how your meetings succeeded and how they could be improved.

:::image type="complex" source="imag../../productivity-mes-insights.png" alt-text="Screenshot that shows insights in the Meeting effectiveness survey section on the Productivity tab.":::
...
2. For **Meeting effectiveness surveys**, select to turn the setting **On** or **Off**, and then select **Save**. This setting defaults to **On**.
    ...
    :::image type="content" source="imag../../meeting-effectiveness-settings2.png" alt-text="Screenshot that shows Effective meeting settings toggle in the Viva Insights app Settings page." lightbox="imag../../meeting-effectiveness-settings1.png":::
