...
* **Training lead** - Runs a training workshop. The lead can start with [Introduction to Microsoft Viva Learning](https://docs.microsoft.com/microsoft-365/learning) as a resource.
...
Your organization can choose an internal person responsible for training the pilot users. The trainer can use [Introduction to Microsoft Viva Learning](https://docs.microsoft.com/microsoft-365/learning) as a resource
