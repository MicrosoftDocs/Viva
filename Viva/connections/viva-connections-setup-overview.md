...
Use [Viva Connections](viva-connections-overview.md) to engage and empower different employee groups like frontline workers and information workers across your organization. Viva Connections integrates Microsoft 365 apps and tools to create experiences that meet users where they are, keeps them updated on news and announcements, provides access to resources from a desktop or mobile device, and is home to the Viva suite.
...
| :-------------------: | :------------------- | 
| **Plan**  | **Step 1: Set a home site (optional)*** <br> Get a home site and customize global navigation for organizations that have a need for a secondary destination. <br><br> **Step 2: Plan for Viva Connections** <br> Identify and align on key tasks and scenarios that can be supported by Viva Connections. [Learn more about how Viva Connections and home sites work together.](viva-connections-overview.md#how-sharepoint-home-sites-and-viva-connections-work-together)  <br><br> **Step 3: Plan the dashboard** <br> Learn more about the different kinds of cards and how they can support specific scenarios. <br><br> **Step 4: Get ready for the Feed** <br> Consider ways to influence the order of content in the Feed. <br><br> **Step 5: Plan Resources** <br> Determine which links belong in the resources section. <br><br> **Step 6: Create an adoption plan** <br> Create a plan to help the rest of the organization adopt Viva Connections. [Learn more about Viva Connections adoption](https://adoption.microsoft.com/files/viva/connections/Adoption-Recommended-Practices-for-Viva-Connections.pdf). <br><br> **Step 7: Consider success metrics** <br> Think about how your organization will determine if Viva. Connections is meeting specific needs. <br><br> **Step 8: Plan for maintenance over time** <br> Consider which parts of the experience may need to be refreshed over time.|  
| **Build** | **Step 1: Create a Viva Connections dashboard*** <br> The Viva Connections experience includes a set of default cards. Add more cards, apply audience targeting, and then preview the experience before publishing if needed. <br><br> **Step 2: Enable the Viva Connections app in Microsoft Teams** <br> Add the app in the Teams admin center, specify a logo, and customize settings. <br><br> **Step 3: Ensure high-traffic sites and portals are healthy** <br> Run a health check and make sure everyone has access to the right content. <br><br> **Step 4: Test and refine the experience** <br> Find people in your organization who can test the experience before it's released more broadly. |  
