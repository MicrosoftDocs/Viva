...
- If the site you want to be your home site isn't currently your root site and you want it to be, first [replace your root site with the site](/sharepoint/modern-root-site), and then make the site your home site. If you set up a home site first, and then replace it with your root site, you may lose home site settings and need to reapply them.  
...
| ![image of a two sites getting switched](../media/connections/icon-build-swap.png)   | **Replace the home site with the root site**  | Before you set a communication site as the home site, make the communication site the root site of your tenant as a best practice. The root site for your organization is one of the sites that's provisioned automatically when you purchase and set up a Microsoft 365 plan. If you set up a home site first, and then replace it with your root site, you may lose home site settings and need to reapply them. Learn how to [make the root site the home site](/sharepoint/modern-root-site#replace-your-root-site).|
