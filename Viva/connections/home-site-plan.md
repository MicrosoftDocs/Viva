...
When you've prepared a plan, you're ready to start creating the home site in SharePoint. Start with a communication site, and after you have the general layout finalized, create a [Viva Connections experience from your existing home site](https://learn.microsoft.com/viva/connections/set-up-admin-center#build-from-an-existing-intranet-portal) in the Viva Connections admin center.
