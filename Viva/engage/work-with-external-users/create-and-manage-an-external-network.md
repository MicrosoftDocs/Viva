...
1. Select the Yammer settings icon :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false":::, and then go to **Networks** \> **Create a New Network**.
...
4. To start inviting people to join your external network, click the external network settings icon :::image type="icon" source="../../media/e1f84edf-4842-4732-89b2-f7e46e4c94e1.png" border="false":::, and then click **Invite**.
...
To get to an external network from your home network, click the Yammer settings icon :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false":::, and then near the bottom of the settings list, select the external network, or select **Browse External Networks**.
...
1. To go to your external network, click the Yammer settings icon :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false":::, and then select an external network, or select **Browse External Networks**.
...
1. To go to an external network, click the Yammer settings icon :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false":::, and then select an external network, or select **Browse External Networks**.

   :::image type="content" source="../../media/1338f356-0650-477c-a1fd-653d15753fca.png" alt-text="Screenshot of the settings menu for an external network.":::
  
2. In the external network, click the external network settings icon :::image type="icon" source="../../media/e1f84edf-4842-4732-89b2-f7e46e4c94e1.png" border="false":::.
