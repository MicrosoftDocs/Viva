...
2. Click **Export Users**.
    ...
    :::image type="content" source="../../media/69748f25-6619-4d2f-b9c8-17f02b726a98.png" alt-text="Screenshot showing Yammer Export Users menu.":::
  
3. On the Export Users page, choose **Export all users**, and then click **Export**.
    
    :::image type="content" source="../../media/71c292af-9ca0-447a-8750-20b49bd1330e.png" alt-text="Screenshot showing Yammer Export Users options - Export all users or Export all users since (date).":::
