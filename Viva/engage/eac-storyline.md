...
Once you're in the **Manage Storyline** interface, admins will see the toggle which controls the availability of Storyline within your organization. When Storyline is enabled in your organization, it's available to all internal users who have access to Viva Engage. All internal users will have their own Storyline feed on their profile page and will be able to see, react, and respond to others’ Storyline posts.  
