...
All Storyline content is available through [network data export](/viva/engage/eac-as-manage-data#export-tenant-data-by-date-range). Networks in Native Mode can also access this content [through eDiscovery](eDiscovery-engage.md).
