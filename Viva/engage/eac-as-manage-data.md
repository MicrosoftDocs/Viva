...
:::image type="content" source="../viva/media/engage/admin/eac-data-export.png" alt-text="Use the Governance and compliance tab to find your data export options.":::
...
:::image type="content" source="../viva/media/engage/admin/export-data-tenant.png" alt-text="Export options let you choose a date range and other filters.":::
...
| **Messages.csv** | All messages sent or modified during the specified date range. **Properties include:** message ID, thread ID, group ID, group name, GDPR deletion URL (**gdpr_delete_url**), privacy status, sender ID, name and email, the full body of the message, attachments, and creation and deletion information. <br>See [Find specific Viva Engage messages or files](https://learn.microsoft.com/en-us/yammer/manage-security-and-compliance/export-yammer-enterprise-data). <br> |
