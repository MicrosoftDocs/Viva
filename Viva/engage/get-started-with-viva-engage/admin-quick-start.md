...
1. Go to the Yammer admin center.
      ...
      - Or, in Yammer, click the Yammer settings icon :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false":::, and then click **Network Admin**.
    
2. Click the links in the **New Network Checklist** to get started. 
    
    :::image type="content" source="../../media/ff561537-c263-4dcb-91bc-feba6a7691eb.png" alt-text="Screenshot of the checklist with basic tasks for setting up a Yammer network.":::
...
For links to everything you need to administer your network, see [Yammer admin help](../overview.md).