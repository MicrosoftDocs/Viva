...
3. For each network you belong to, select **Download Data**. 
    ...
    :::image type="content" source="../../media/b8b47324-6eaa-4f20-a211-e329b29c2b57.png" alt-text="Screenshot of the networks page, to export data, use the Download Data link next to the network name.":::
