...
Users can go to Yammer settings :::image type="icon" source="../../media/9704ce70-56ce-43f7-96c6-f253b0413d40.png" border="false"::: \> **Edit settings** \> **Notifications** and select which notifications to receive.
  
:::image type="content" source="../../media/845bf2cb-dd3b-4004-849a-fe083be86d88.png" alt-text="User settings for when notifications are sent by email.":::
