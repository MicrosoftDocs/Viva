...
> [!IMPORTANT]
> Images that include teams and attributes notes as "Not displayed" are for illustrative purposes only. Scores and comments that don't meet Viva Glint confidentiality and suppression thresholds aren't displayed in reports.
