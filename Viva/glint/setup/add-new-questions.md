...
### Follow these steps to find a question from the Viva Glint Question Library:
...
1. Use the **More Filters** button to open a More Filters window. Within this window, select from these options:
   ...
   1. Select **Show Questions** to reveal your newly filter list.
...
1. Select the **+ Create** button. A Create Question slider window opens.
...
1. For your new item, complete the following fields:
