...
> [!NOTE]
> This SFTP feature will be available in Viva Glint after **October 28th, 2023**.
...
1. In the SFTP pane that appears, review each field and enter information as needed:
   ...
   1. **SFTP Credentials:** Use the credentials shown here to connect to SFTP with a dedicated FTP application and your private SSH key file.  
...
> [!NOTE]
> Allow at least 1 hour after entering public SSH keys and IP addresses before testing your connection.
