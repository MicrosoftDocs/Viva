...
- Attribute Rules - [User rules](#create-an-attribute-rule-based-user-role) like location or department to populate a User Role. This dynamically changes with your employee data uploads.
