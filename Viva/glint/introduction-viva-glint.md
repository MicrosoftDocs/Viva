...
|:---|:---|:---|
|:::image type="icon" source="/office/media/icons/administrator.png" ::: | **Set up and adjust surveys** | <ul><li>[Confirm current data uploaded](/viva/glint/setup/people-page)</li> <li>[Select a survey population](/viva/glint/setup/set-up-distribution-lists)</li> <li>[Set up a survey](/viva/glint/setup/program-summary-overview)</li> <li>[Select new survey items](/viva/glint/setup/add-new-questions)</li> <li>[Consider updates to survey communications](/viva/glint/setup/email-content-customization)</li> <li>[Define feedback goals](/viva/glint/people-science/people-science-explains-focus-areas)</li></ul>|
