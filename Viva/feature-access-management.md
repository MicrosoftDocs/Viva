...
|Viva Pulse|[Customization](https://learn.microsoft.com/en-us/viva/pulse/setup-admin-access/set-up-in-app-pulse-experience#customization)*|No|Global admin|VivaPulse|
