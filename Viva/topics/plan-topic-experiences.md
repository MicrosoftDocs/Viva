...
All users who are going to use Topics require a **Topic Experiences** license. Assigning licenses is covered in [Set up Microsoft Viva Topics](set-up-topic-experiences.md). If you plan to assign licenses programatically, be sure the users already have licenses for Microsoft 365 (for example, E3 or E5) before assigning the Topic Experiences license. 
