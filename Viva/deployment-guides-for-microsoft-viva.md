...
|[Build your Microsoft Viva Glint tenant](https://go.microsoft.com/fwlink/?linkid=2230741)|[Build your Microsoft Viva Glint instance to deploy Viva Glint programs in your organization](https://go.microsoft.com/fwlink/?linkid=2238525)|To deploy apps that use the Microsoft platform, you first need access to an Azure Active Directory (Azure AD) tenant. After tenant provisioning, follow admin next steps to continue Viva Glint deployment to add engagement programs to help meet your organizational goals.|
