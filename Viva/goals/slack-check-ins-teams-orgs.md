...
For Slack integration enabled users, the nudge is received by the Viva Goals Slackbot in the following format. 
 ...
 :::image type="content" source="../media/goals/slack-images/nudge 3.jpg" alt-text="Screenshot of a nudge being delivered by the Slackbot." lightbox="../media/goals/slack-images/nudge 3.png":::
