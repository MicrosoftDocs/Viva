...
1. Select **Admin** from the navigation panel on the left & Select **Viva Goals admin portal**.  
    :::image type="content" source="../media/goals/vg-integrations-admin-overview/vg-admin.png" alt-text="Screenshot of accessing the admin portal from the admin tab in the navigation signbar." lightbox="../media/goals/vg-integrations-admin-overview/vg-admin.png":::
1. Select the integrations settings for your tenant and select save. If you choose the option for Selected integrations are available, select the integrations you want to manage and select save.
    :::image type="content" source="../media/goals/vg-integrations-admin-overview/admin-integrations.png" alt-text="Screenshot of integrations page in the Admin portal." lightbox="../media/goals/vg-integrations-admin-overview/admin-integrations.png":::
