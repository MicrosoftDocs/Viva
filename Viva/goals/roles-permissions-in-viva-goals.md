...
|Alignment     |By default, any regular users in an organization can align to any OKR. OKR owners can also modify permissions at an OKR level to grant extra users with [alignment access](https://prod.support.services.microsoft.com/en-us/topic/collaborate-43673d1c-0dd7-42ba-97aa-6e712db171d1).         |
