...
|Organization admins      |  In case you want to understand more about Organizations, see [What is Organization?](understand-orgs-and-teams.md). <br> </br> Organizational administrators are members who manage the OKR process rollout for the org. In an organization, they're generally the OKR champions. They can configure OKR process properties (such as Time period), add or remove users in the org, and create teams within an organization. An organization can have more than one organization administrator.  | Some tasks managed by Organization Admins are<br> </br> -  creating OKRs for any team  <br> </br> - accessing the [admin settings](navigate-admin-dashboard.md) at the org level. <br></br> - setting policy on who can add members to the org, create teams in the org, create new tags, and export OKRs from their org.  <br> </br> -  Organization admins can also change time-period and notification setting options.    |
