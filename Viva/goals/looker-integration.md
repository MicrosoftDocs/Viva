...
2. Scroll through the list until you reach Looker. Select **Enable** (Or **Manage** if a connection has been made previously).
  ...
  :::image type="content" source="../media/goals/5/looker-enable-button-in-viva-goals.png" alt-text="Enabling Looker in Viva Goals." lightbox="../media/goals/5/looker-enable-button-in-viva-goals.png":::

3. The integration can also be disabled at any time from the same section.

  :::image type="content" source="../media/goals/5/disabling-looker-integration-in-viva-goals.png" alt-text="Disabling Looker in Viva Goals." lightbox="../media/goals/5/disabling-looker-integration-in-viva-goals.png":::
...
:::image type="content" source="../media/goals/5/creating-a-new-connection-in-looker.png" alt-text="Creating a new Looker connection in Viva Goals." lightbox="../media/goals/5/creating-a-new-connection-in-looker.png":::
...
2. From the list of integrations, select **Looker**.
  ...
  :::image type="content" source="../media/goals/5/looker-integration-in-the-data-sources-list.png" alt-text="Selecting Looker from the list of data sources in Viva goals.png." lightbox="../media/goals/5/looker-integration-in-the-data-sources-list.png":::
...
4. Once the connection is selected, you can choose to **Track KPI from** either a dashboard or a look. Once you've chosen a dashboard or a look, you can further narrow it down to a specific dashboard tile or a look name. Select the tile or look that has the data you want to be connected to the OKR.
  ...
  :::image type="content" source="../media/goals/5/looker-data-for-okrs-updation-in-viva-goals.png" alt-text="Adding Looker connection to your OKRs in Viva goals.png." lightbox="../media/goals/5/looker-data-for-okrs-updation-in-viva-goals.png":::
