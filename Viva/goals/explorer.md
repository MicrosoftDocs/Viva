...
Explorer can generate preset views and create custom views. Use Explorer to filter out objectives and key results (OKRs) and projects of interest, and save commonly viewed filters to quickly access them again in the future.
...
Filters are better when used in combination. To create meaningful and relevant views,  combine several filters.
...
- Select the exact fields to include in the export file.

- Include key results/projects along with the objectives exported. In this case, first level of key results/children will be exported along with each objective.
...
![Screenshot shows the dialog where you rename a view.](../media/goals/4/46/d.jpg)
...
![Screenshot showing where you save a new view.](../media/goals/4/46/e.jpg)
...
![Screenshot shows the Explorer All Objectives view.](../media/goals/4/46/g.jpg)
