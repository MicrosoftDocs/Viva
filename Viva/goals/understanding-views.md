...
- **Time periods** - Time periods are the OKR operating periods or cycles. Every OKR or Project is always tagged to a particular time period and has a start & end date. Time periods are key to help you navigate and find OKRs and Projects for an organization, team or a user.

- **Summary panel** - View the progress and status of all your OKRs in that time period, along with the expected vs. actual progress comparison.

- **3KPIs panel** - You can view the KPIs that are used to track your OKRs in this section. 

- **Add objective** - Create an objective of the type of organization/team/individual.
...
- **Bulk Check-in** - Make check-ins on multiple OKRs that were not updated since the last check-in reminder in a guided workflow.
...
- **OKR Progress** - The progress you have made on the current objective, expected progress, and your OKR's progress status. You can make progress updates in two ways: dragging the progress scroll bar to input your updates or clicking the ‘check-in’ button and entering your progress. 

- **Manage Contributions** - Control how much contribution each child makes to the progress of the current objective. 

- **Last Check-in Note** - Shows you the most recent check-in on an OKR so you can extra context to your Progress chart. If you don't see any check-in notes, it might be a good idea to add one.

- **Owner** - Shows the owner of the objective.

- **Type** - Shows whether an OKR is for an organization, team or individual. You can change the type in this tab.
