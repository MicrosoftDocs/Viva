...
To link your Slack workspace with Viva Goals, navigate to Admin > Integrations > Slack in your Viva Goals account. Click on **Add to Slack**. Next, select the workplace from the top right corner of the page, and click on **Authorize**. 
 ...
 :::image type="content" source="../media/goals/Slack/admin.png" alt-text="Screenshot of the integrations page in Viva Goals." lightbox="../media/goals/Slack/admin.png":::

 :::image type="content" source="../media/goals/Slack/consent.png" alt-text="Screenshot of the Viva Goals requesting permissions from Slack." lightbox="../media/goals/Slack/consent.png":::

 :::image type="content" source="../media/goals/Slack/welcome.png" alt-text="Screenshot of the Viva Goals app within Slack." lightbox="../media/goals/Slack/welcome.png":::
...
:::image type="content" source="../media/goals/Slack/check-in 1.png" alt-text="Screenshot of the Viva Goals check-in notification within Slack: an OKR needs to be updated." lightbox="../media/goals/Slack/check-in 1.png":::

:::image type="content" source="../media/goals/Slack/check-in proj.png" alt-text="Screenshot of the Viva Goals check-in notification within Slack: projects need to be updated." lightbox="../media/goals/Slack/check-in proj.png":::
...
:::image type="content" source="../media/goals/Slack/notification.png" alt-text="Screenshot of the Slack notification settings within Viva Goals." lightbox="../media/goals/Slack/notification.png":::
...
:::image type="content" source="../media/goals/Slack/channel notification.png" alt-text="Screenshot of the Viva Goals notification within Slack." lightbox="../media/goals/Slack/channel notification.png":::
...
:::image type="content" source="../media/goals/Slack/preview 1.png" alt-text="Screenshot of a preview of a sample Viva Goals OKR shared on a Slack conversation." lightbox="../media/goals/Slack/preview 1.png":::

:::image type="content" source="../media/goals/Slack/preview 2.png" alt-text="Screenshot of a preview of a sample Viva Goals Project shared on a Slack conversation." lightbox="../media/goals/Slack/preview 2.png":::
...
:::image type="content" source="../media/goals/Slack/share 1.png" alt-text="Screenshot of a how to share a summary from Viva Goals." lightbox="../media/goals/Slack/share 1.png":::
...
:::image type="content" source="../media/goals/Slack/share 2.png" alt-text="Screenshot of a how to share a summary from Viva Goals with the include followers checkbox selected." lightbox="../media/goals/Slack/share 2.png":::

Click on **Add a personal note** if you want to add more context while sharing the summary of objectives. 

:::image type="content" source="../media/goals/Slack/share 3.png" alt-text="Screenshot of a how to share a summary from Viva Goals with the your notes section filled out." lightbox="../media/goals/Slack/share 3.png":::
...
:::image type="content" source="../media/goals/Slack/share 4.png" alt-text="Screenshot of a shared summary from Viva Goals within Slack." lightbox="../media/goals/Slack/share 4.png":::
...
:::image type="content" source="../media/goals/Slack/share okr.png" alt-text="Screenshot of a shared Objective from Viva Goals." lightbox="../media/goals/Slack/share okr.png":::

:::image type="content" source="../media/goals/Slack/share slack.png" alt-text="Screenshot of a shared Objective from Viva Goals within Slack." lightbox="../media/goals/Slack/share slack.png":::
...
:::image type="content" source="../media/goals/Slack/follow 1.png" alt-text="Screenshot of how to follow in Viva Goals." lightbox="../media/goals/Slack/follow 1.png":::
...
:::image type="content" source="../media/goals/Slack/follow 2.png" alt-text="Screenshot of how to add a follower in Viva Goals." lightbox="../media/goals/Slack/follow 2.png":::

Search users or slack channels and select the + sign next to the search result to add them as a follower. 

:::image type="content" source="../media/goals/Slack/follow 3.png" alt-text="Screenshot of selecting the + sign to add a follower in Viva Goals." lightbox="../media/goals/Slack/follow 3.png":::
...
:::image type="content" source="../media/goals/Slack/follow 4.png" alt-text="Screenshot of selecting the gear icon to modify the follow settings." lightbox="../media/goals/Slack/follow 4.png":::
...
:::image type="content" source="../media/goals/Slack/follow 5.png" alt-text="Screenshot of selecting the notification settings." lightbox="../media/goals/Slack/follow 5.png":::
...
:::image type="content" source="../media/goals/Slack/follow 6.png" alt-text="Screenshot of the notification banner appearing at the bottom of the screen." lightbox="../media/goals/Slack/follow 6.png":::
...
:::image type="content" source="../media/goals/Slack/acc setting 1.png" alt-text="Screenshot of selecting the account settings within Viva Goals." lightbox="../media/goals/Slack/acc setting 1.png":::
...
:::image type="content" source="../media/goals/Slack/acc setting 2.png" alt-text="Screenshot of the following and followers tab in Viva Goals." lightbox="../media/goals/Slack/acc setting 2.png":::

Users can restrict others from following themselves by toggling **Allow other people to follow me.** 

:::image type="content" source="../media/goals/Slack/acc setting 3.png" alt-text="Screenshot of the restricting followers in Viva Goals." lightbox="../media/goals/Slack/acc setting 3.png":::
...
:::image type="content" source="../media/goals/Slack/unfollow.png" alt-text="Screenshot of how to unfollow in Viva Goals." lightbox="../media/goals/Slack/unfollow.png":::
...
:::image type="content" source="../media/goals/Slack/digest update.png" alt-text="Screenshot of digest update in Slack." lightbox="../media/goals/Slack/digest update.png":::
...
The **Nudge** option is available in the progress popover when you click on it. It will be visible to the users who are not the primary check-in owner of the OKR or project.
 ...
 :::image type="content" source="../media/goals/Slack/nudge 1.png" alt-text="Screenshot of where to find the nudge button in Viva Goals." lightbox="../media/goals/Slack/nudge 1.png":::
...
In the popup, you can also see how the check-in owner will be notified. The nudge will go out on Slack if the organization is integrated with Slack. 
 ...
 :::image type="content" source="../media/goals/Slack/nudge 2.png" alt-text="Screenshot of a filled out nudge request." lightbox="../media/goals/Slack/nudge 2.png":::

For Slack integration enabled users, the nudge is received by the Viva Goals Slackbot in the following format. 

 :::image type="content" source="../media/goals/Slack/nudge 3.png" alt-text="Screenshot of a nudge request being delivered by the Slackbot." lightbox="../media/goals/Slack/nudge 3.png":::