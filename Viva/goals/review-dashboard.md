...
- To view the company-level review dashboard, select the **organization’s OKRs** tab in the left pane, and then  select the **Dashboard** tab.
...
![Screenshot shows where you select the review period.](../media/goals/4/42/f.jpg)
