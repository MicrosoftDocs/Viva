...
If you started using the Business continuity dashboard in April or May 2020 and you selected to use six months of data for your queries, you need to repeat the steps in [Set up the dashboard](#set-up-the-dashboard) to run new queries with data from the last one year to continue to include activity before and during the shift to remote work in March. However, if you want to continue to use your custom version of the Business Continuity dashboard and not update to the latest version of the template, then do the following instead of **Steps 8-15** in [Set up the dashboard](#set-up-the-dashboard): 
