...
>[!Note]
>*This template will no longer be available in Workplace Analytics around April 22 2021. See [Power BI templates](power-bi-intro.md) for the current list of new templates.
