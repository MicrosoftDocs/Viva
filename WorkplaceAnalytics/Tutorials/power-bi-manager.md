...
* **Coach - Do managers have enough time for their employees?** - Shows how many hours managers spend collaborating on average per week with people in the organization and the average percentage of of collaboration time that is spent with direct reports as compared to others in the organization.
* **Coach - Are employees receiving sufficient coaching time with their manager?** – Shows the monthly average minutes that employees spent in 1:1 meetings with their direct managers and the percentage of employees for each category of minutes in the last four weeks. It also shows the percentage of employees who meet 1:1 with their manager at least one time each month.
...
* **Empower - How are manager habits impacting employee empowerment, workflows, and trust?** - 
* **Connect - Do managers have a large diverse and influential network to enable and support their teams?** - 
* **Model - Are managers modeling good work-life balance?**
* **Track - How are managers behaviors evolving?** - 
* **Improve - How can manager effectiveness be improved?** - 

![Manager effectiveness dashboard in Power BI](../Images/WpA/tutorials/pbi-manager-effect.png)

To populate the dashboard in Power BI, you must set up and successfully run the predefined **Manager effectiveness** query in Workplace Analytics.
