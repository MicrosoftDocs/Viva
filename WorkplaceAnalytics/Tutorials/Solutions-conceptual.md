...
Groups and programs are displayed on the **Solutions** > **Manage** page of Workplace Analytics. You can track groups and programs in the following columns on this page: 
...
On the **Solutions** > **Identify** > **Collaboration Overload** page, sets of employees are displayed below the chart:
...
* Change the chart view. If you change the selections in the **Chart** (such as **Group by**) and then select **Apply**, your group selections are lost.
