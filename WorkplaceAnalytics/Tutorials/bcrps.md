...
>[!Note]
>Microsoft 365 users in an organization that has at least 100 active Exchange Online users with active [MyAnalytics licenses](../myanalytics/overview/plans-environments.md) can see this report when they register for the Productivity Score preview.
