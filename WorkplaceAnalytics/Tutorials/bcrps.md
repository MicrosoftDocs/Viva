...
|-------------|--------------|-------------|
|How is employee collaboration changing? |As remote work becomes the new normal, using online communication tools for collaboration and teamwork will help people in your organization succeed. |**Collaboration hours** - Total time employees spent in meetings, chats, and on email activity shown on average weekly. The hours include both internal and external hours. <br> <br>**Collaboration time for meeting activity** - The sum of the durations of meetings an employee has on their calendar (not counting meeting time that overlaps). <br> <br>**Collaboration time for email activity** - Approximated as 5 minutes for a composed email, and 2.5 minutes for a read email. <br> <br>**Collaboration time for instant message activity** - Approximated by 30 seconds for each instant message (sent and received). |
