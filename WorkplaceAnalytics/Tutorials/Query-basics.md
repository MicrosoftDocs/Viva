...
The historical data on which queries are run is time limited: You can run queries only on data that is no older than 27 months. This 27-month period is a _rolling window_. This means that&mdash; after you have 27 months of data&mdash;as [Office 365 data](data-sources.md#office-365-data-summary) is refreshed each week, the 27-month extent of data that is queryable advances by one month to include the preceding 27 months. 
