...
6. Under **Select metrics**, select **Influence** and/or **Influence rank**. Optionally, you can also edit the **Display name** of these metrics; the edited name will appear as a column name in the query results. (Other metric customization options are not available.)
