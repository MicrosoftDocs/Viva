...
The first application of differential privacy in Workplace Analytics is within [Insights for people managers](../use/pm-home.md). These insights enable managers to understand how the people in their team are doing by using aggregated collaboration data and to learn how to drive change.
