...
Microsoft supports the GDPR [Right to erasure](https://docs.microsoft.com/compliance/regulatory/gdpr-dsr-Office365#deleting-personal-data). Data subjects can request that their query results be deleted and that no organizational or CRM data that includes their data be used.

<!-- ONE VERSION:
Also, customers can decide whether to have their reports and previously processed datasets deleted. Customers can delete their query results, and re-upload their organizational or CRM files, if needed. -->
