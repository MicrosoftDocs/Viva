...
title: Format data for uploading in Workplace Analytics
description: How to format .xlsx files and .csv files for uploading in Workplace Analytics 
author: madehmer
ms.author: v-pausch
ms.topic: article
...
2. [Field mapping](upload-organizational-data-1st.md#field-mapping). After the data file is uploaded, you will encounter the mapping screen, where you map the source columns in the data file to Workplace Analytics names and select a data type.
