...
|   [3 - Assign roles to WpA Admin and Analysts](#step-three-assign-roles-to-Workplace-Analytics-Admins-and-Analysts)   |    Office 365 global administrator   |     Administrator can use Workplace Analytics to set system defaults, privacy settings, upload and verify organizational data; data analysts can log into and use Workplace Analytics once data is provisioned    |
