...
Workplace Analytics combines your organizational data with Office 365 to provide rich, actionable insights into your company’s communication and collaboration trends to help you make more effective business decisions.

### About organizational data
Organizational data is the information about employees that your company provides to use in Workplace Analytics. 
...
- Sourced from multiple sources
    ...
    - CRM Systems
- In Workplace Analytics, organizational data is structured as a flat file where each row represents one person and columns represent attribute fields

### How organizational data is used
...
### How often to refresh organizational data
...
#### Who to include in the organizational data file
- HR Data:
    - We recommend that HR data is included for all employees in your company, even if they are not part of the measured population
