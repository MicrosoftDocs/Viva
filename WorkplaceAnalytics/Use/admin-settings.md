...
description: Describes the settings in Workplace Analytics that administrators can set and edit
author: madehmer
ms.author: v-mideh
ms.topic: article
...
As a [Workplace Analytics Admin](settings.md), you can use **Admin settings** to configure [system defaults](#system-defaults), [privacy settings](#privacy-settings), and [manager settings](#manager-settings).
