...
**Internal network size** is the average number of people with whom a person has at least two meaningful interactions (an email, meeting, call, or three instant messages involving from two to eight people). Network connections are measured on a rolling four-week basis.
...
Internal network breadth is the average number of organizations an employee connected with (based on meaningful interactions) during the period selected. (A meaningful interaction consists of an email, meeting, call, or three instant messages involving from two to eight people.)
