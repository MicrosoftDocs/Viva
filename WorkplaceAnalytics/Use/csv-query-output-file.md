...
In some instances, certain people may not have the organizational attribute defined. (City is an HR attribute). This might be because such employees are mobile and do not have fixed location, and cannot be classified by city. Such employees will be placed in the _Other Collaborators_ category.
