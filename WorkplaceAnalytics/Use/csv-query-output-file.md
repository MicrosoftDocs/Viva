...
* For *Time investor initiated meeting hours* - This is the total number of meeting hours generated by a time investor as the meeting organizer for *other licensed* employees in the time investor group. For example, meeting hours generated by a time investor in Group A for other Group A employees. This total does not include the meeting organizer's time spent in the meeting.

* For *all other metrics*, such as meeting hours or collaboration hours - The values are only for the time investors who are *licensed* employees. For example, meeting hours generated by a time investor in Group A for all Group A employees, including the organizer's time.

>[!Note]
> Time spent by *unlicensed* employees from Group A are not included in any of the **Collaborators within group** totals. For example, unlicensed employees could be vendors or employees who no longer work there (hence unlicensed) but are still included in your organizational data.
