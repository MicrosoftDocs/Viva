...
> [!Note] 
> You can also locate the Viva Insights app through this link: https://aka.ms/InsightsTeamsApp. 
...
3. Pin the Viva Insights app to the left navigation pane of Teams for all employees in your organization: [Pin the Insights app](Pin-the-Insights-app.pdf). 
...
5. [Assign roles](../setup/assign-roles-to-wpa-admins.md) to business leaders -- specifically, either the Workplace Analytics analyst role or the analyst (limited) role. For information about the differences between these roles, see [Role descriptions and access levels](../use/user-roles#role-descriptions-and-access-levels). 
...
![Insights best practice - increase frequency](../images/wpa/use/teams-bestprac-freq-coaching-70.png)
...
* [Microsoft Viva Insights app - personal insights](https://docs.microsoft.com/workplace-analytics/myanalytics/use/teams-app)
