...
* **Explore the stats** – The following recommendations link to more in-depth data about your organization's [management and coaching](explore-metrics-management-and-coaching.md) or [teamwork](../tutorials/teamwork-solution.md), which you can access directly in Workplace Analytics with the following links:
  ...
  * **Find unexpected leaders**, **Increase frequency of coaching**, and **Increase information sharing** > [**Management and coaching**](https://workplaceanalytics.office.com/Home/OrganizationalResiliency/ManagementCoaching)
