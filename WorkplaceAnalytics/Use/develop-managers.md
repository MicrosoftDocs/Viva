...
|---------|--------|----------------------|
|Optimize meeting hours |Manager meetings by duration and number of attendees | Shows the percentage of [manager meetings](metric-definitions.md#meeting-hours-with-manager-define) based on their type, including: [Large meetings](glossary.md#large-meeting-define) that have more than eight attendees but have a duration of less than one hour, [long meetings](glossary.md#long-meeting-define) that are longer than one hour with less than or equal to eight attendees, [long and large meetings](glossary.md#long-and-large-meeting-define) with more than eight attendees and are longer than one hour and [decision-making meetings](glossary.md#decision-making-meeting-define) with between two and eight attendees and are less than one hour in duration. |
|Prevent burnout |Distribution of after-hours collaboration from managers |Percentage of managers based on their weekly [after hours collaboration](metric-definitions.md#after-hours-collaboration-define). They are divided into those who spent less than one hour, between one to five hours, and more than five hours collaborating after hours. These percentages are calculated weekly and averaged over the entire time period. |
