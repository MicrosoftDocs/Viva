...
|Peer average (external collaboration) | The total amount (in hours) of the participant's external collaboration divided by the number of participants in the plan. | Person | Hour | No|
|Peer average (internal collaboration) | The total amount (in hours) of the participant's internal collaboration divided by the number of participants in the plan. | Person | Hour | No|
