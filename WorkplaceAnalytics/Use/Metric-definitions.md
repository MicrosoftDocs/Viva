...
|LastTimeContacted |The last date and time that a measured employee emailed or attended a meeting with one or more people in the collaborator group for the specified date range. |Group|DateTime|No|
