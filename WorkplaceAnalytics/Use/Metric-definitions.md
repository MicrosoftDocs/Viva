...
|------|-----------|----------|---------|------------|
|After-hours collaboration hours|Number of hours the person spent in meetings and on email outside of working hours.|Person|Hour|No|
...
|Multitasking meeting hours|Number of meeting hours where the person sent:<ul><li>Two or more emails per meeting hour</li><li>Two or more emails per meeting for meetings less than one hour</li></ul>|Person|Hour|Yes|
...
|Open 1-hour blocks|Number of one-hour blocks in the person’s calendar without meetings during the work day.|Person|Count|Yes|
...
|Working hours email hours|Number of hours the person spent sending email during working hours.|Person|Hour|No|
...
|Attendees multitasking|Number of attendees who sent emails during the meeting.<ul><li>In meetings of one hour or less, two or more emails.</li><li>In meetings longer than one hour, two emails per hour. (Example: Sending four emails during a two-hour meeting would count as multitasking.)</li></ul>|Meeting|Count|Yes|
...
|Total redundant hours|Sum of redundant hours for each meeting attendee.|Meetings|Count|Yes|
