...
| <a name="meeting-define"></a> Meeting | An audio or video communication or in-person meeting that has been scheduled -- that is, it appears on a person's Outlook calendar. A meeting must involve two or more people. While the meeting's duration is based on the Outlook calendar event, it might not have the exact same duration as that event because Workplace Analytics applies post-processing logic that includes the removal of overlapping meetings and the application of meeting exclusions. |
