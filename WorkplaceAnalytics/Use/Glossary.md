...
| <a name="collaboration-activity-define"></a> Collaboration activity | A meeting, email, IM, or call, measured after deduplication of time due to overlapping activities (for example, calls during a meeting). |
