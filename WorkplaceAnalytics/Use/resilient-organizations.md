...
* **Explore the stats** – Depending on the recommendations, this links to [Teamwork data](../tutorials/teamwork-solution.md) or [Management and coaching data](explore-metrics-management-and-coaching.md).
