...
description: Describes the manager settings in Workplace Analytics and how administrators can set them up and edit them for your organization
author: madehmer
ms.author: v-mideh
ms.topic: article
...
> [!Important]
> Only Viva Insights or Workplace Analytics admins can access **Manager settings**. Also, before managers can access Workplace Analytics, they must be assigned a Workplace Analytics license and have a team that meets or exceeds the **Minimum team size** setting.
