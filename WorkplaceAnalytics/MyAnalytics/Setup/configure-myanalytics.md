...
title: MyAnalytics configuration for Microsoft 365 administrators
description: Configuration options that Microsoft 365 administrators can make for MyAnalytics users
author: madehmer
ms.author: v-pausch
ms.topic: article
