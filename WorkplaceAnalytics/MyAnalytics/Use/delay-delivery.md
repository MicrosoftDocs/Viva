...
_**Applies to:** The Delay delivery plan is currently available only to people who are using  MyAnalytics and are enrolled in a [MyAnalytics (Full) service plan](../myanalytics/overview/plans-environments.md#features-in-the-myanalytics-full-service-plan)._
