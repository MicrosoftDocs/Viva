...
|**Respond** (RSVP)  &emsp; &emsp; &emsp;&emsp; | This section is only for invitees, not for the organizer. <p>You can respond **Yes** or **No** to the invitation. If you have already responded, your response is shown here. <p>If the meeting is scheduled outside of working hours, you'll see a message about it as an after-hours conflict and an option to respond accordingly. | Responses help the organizer determine whether required participants can attend, and then take any necessary steps, such as rescheduling. |
