...
MyAnalytics is included with Office 365 Enterprise E5 and is also available as an add-in with select plans. [Learn more](https://products.office.com/business/myanalytics-personal-analytics?ms.officeurl=MyAnalytics).
-->
