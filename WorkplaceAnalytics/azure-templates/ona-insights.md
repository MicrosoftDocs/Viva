...
* **Network Silo** - Helps quantify how connected or siloed a network is. Based on the network measure modularity, a low score suggests that employees communicate across the organization regardless of whether they're in the same workgroup or a different workgroup. A high modularity would mean employees primarily communicate to others in their workgroup. Workgroups of employees are determined using community detection, not the formal hierarchy. A very high score might indicate that a network is at risk of being "siloed" where employees are only communicating with others in their workgroup and few others. This is also available through the downloaded data. For more details about this measure, see the [measure calculations](ona-metric-calculations.md#network-silo).
...
* **Community detection** - Identifies group clustering of employees who collaborate more with each other than with the rest of the organization. These workgroups are independent of the formal organizational structure and represent how individuals naturally work together. This is also available through the downloaded data. For more details about this measure, see the [measure calculations](ona-metric-calculations.md#community-detection).
...
* **Freedom** - Calculated by comparing the alignment of employee workgroups, as defined by community detection, to the formal organizational structure. High freedom indicates workgroups who collaborate freely across organizational boundaries and their collaboration does not align with the organizational chart. Low freedom indicates that the organizational chart aligns well with how employees collaborate. See [measure calculations](ona-metric-calculations.md#freedom) for more details.
