...
>[!Note]
>The People Manager role is not assigned like the other roles. People managers get access to their team's data in Workplace Analytics as set in [Manager settings](../use/settings.md#manager-settings).
